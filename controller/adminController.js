...
const admin = async (req, res) => {
    try {
        ...
        const admin_image = req.file.path;
        ...
        return res.status(201).json({
            ...
            data: {
                ...
                aid: newAdmin.aid,
                admin_image: newAdmin.admin_image,
...
const updateAdminProfile = async (req, res) => {
    try {
        ...
        if (req.file) {
            adminData.admin_image = `/uploads/admin_images/${req.file.filename}`;
        }
        ...
        return res.status(200).json({
            ...
            data: {
                ...
                email: adminData.email,
                aid: adminData.aid,
                admin_image: adminData.admin_image,
                createdAt: adminData.createdAt,
                updatedAt: adminData.updatedAt,
            },
        });
