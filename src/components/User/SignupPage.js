...
const SignupPage = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Append business profiles as JSON string
      ...
      if (showFamilyDetails) {
        ...
        // Convert comma-separated children names to array
        ...
        // Append family details as JSON string
  ...
  return (
    <Box sx={{ maxWidth: 600, mx: 'auto', bgcolor: '#fff', p: 3, overflowY: 'auto' }}>
      ...
      <Box sx={{ display: 'flex', justifyContent: 'center', my: 2 }}>
        <Button variant="contained" sx={{ borderRadius: 25, backgroundColor: 'green', mr: 1 }}>
          {t('signup')}
        </Button>
        <Button variant="outlined" sx={{ borderRadius: 25 }} component={Link} to="/login">
          {t('signin')}
        </Button>
      </Box>
      ...
      <FormControlLabel
        control={<Checkbox checked={showReferral} onChange={() => setShowReferral(prev => !prev)} />}
        label={t('Do You Have Referral')}
      />
      <br />

      {showReferral && (
        <>
          <Typography fontWeight="bold" mt={2}>{t('Referral Person Details')}</Typography>
          <TextField
            fullWidth
            margin="dense"
            label={t('referralname')}
            name="referral_name"
      ...
      {/* Business Details - Mandatory (Always Visible) */}
      ...
      {formData.business_profiles.map((profile, index) => (
        <Box key={index} sx={{ my: 2, p: 2, border: '1px solid #ccc', borderRadius: 1 }}>
          ...
          <TextField
            ...
            onChange={(e) => handleBusinessProfileChange(index, e)}
            error={!!errors[`business_company_${index}`]}
            helperText={errors[`business_company_${index}`]}
            required
          />
          ...
          <TextField
            ...
            value={profile.email}
            onChange={(e) => handleBusinessProfileChange(index, e)}
            error={!!errors[`business_email_${index}`]}
            helperText={errors[`business_email_${index}`]}
            required
          />
          ...
          <TextField
            fullWidth
            margin="dense"
            label={t('businessprofileimage')}
            type="file"
            InputLabelProps={{ shrink: true }}
            inputProps={{ accept: 'image/*' }}
            onChange={(e) => handleBusinessFileChange(index, 'business_profile_image', e.target.files)}
          />
          ...
          <TextField
            ...
            onChange={(e) => handleBusinessFileChange(index, 'media_gallery', e.target.files)}
          />
        </Box>
      ))}
      ...
      <FormControlLabel
        control={
          <Checkbox
            checked={showFamilyDetails}
            onChange={() => setShowFamilyDetails(prev => !prev)}
          />
        }
        label={t('Family Details')}
      />
      ...
      {showFamilyDetails && (
        <>
          ...
          <TextField
            ...
            name="father_contact"
            value={formData.family_details.father_contact}
            onChange={handleFamilyChange}
          />
          ...
          <TextField
            ...
            name="mother_contact"
            value={formData.family_details.mother_contact}
            onChange={handleFamilyChange}
          />
          ...
          <TextField
            ...
            name="spouse_contact"
            value={formData.family_details.spouse_contact}
            onChange={handleFamilyChange}
          />
          ...
          <TextField
            ...
            type="number"
            value={formData.family_details.number_of_children}
            onChange={handleFamilyChange}
          />
